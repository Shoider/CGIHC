...
//Variables para el ejercicio de clase
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Ejercicio En clase, Dragon. DragonAlaDer DragonAlaIzq


		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f - angulovaria / 8, 5.0f+sin(glm::radians(angulovaria * 6)), 6.0));
