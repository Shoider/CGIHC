...
//Se usaron para escribir y leer el archivo adecuadamente
#include <iomanip>
#include <regex>
...
int main()
{
	...
	//	Se borran o comentan estos para la actividad de generar los frames por teclado, tambien se pone en 0 keyframes
