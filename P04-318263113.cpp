...
int main()
{
	...
	*/
	...
	glm::mat4 modelprin(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelaux = model;	//Modelo Auxiliar
		modelprin = model;	//Modelo Principal
		...
		model = glm::scale(model, glm::vec3(8.0f, 4.0f, 3.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.65f, 0.38f, 0.2f);
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.78f, 0.52f, 0.34f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));	//Color
		meshList[0]->RenderMesh();	//Dibuja Cubo
		...
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.32f, 0.24f, 0.06f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));	//Color
		sp.render();
		...
		//Izquierda
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 2.25f, 1.0f));
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 1.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, -1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.90f, 0.70f, 0.45f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));	//Color
		meshList[1]->RenderMesh();	//Dibuja Piramide
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.54f, 0.44f, 0.3f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));	//Color
		meshList[0]->RenderMesh();	//Dibuja Cubo
		...
		model = glm::scale(model, glm::vec3(1.0f, 2.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.62f, 0.55f, 0.45f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));	//Color
		meshList[0]->RenderMesh();	//Dibuja Cubo

		//Izquierda Abajo Huella
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.25f, -1.5f, 0.0f));

		model = glm::scale(model, glm::vec3(1.5f, 1.0f, 1.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.54f, 0.44f, 0.3f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));	//Color
		meshList[0]->RenderMesh();	//Dibuja Cubo
		...
		//Aca abajo esta la grua comentada: -----------------------------------------------------
		...
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 1.0f, 0.0f));	// Rotacion
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
